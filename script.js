...
function initializeApp() {
    // --- TEMPLATES // 
    // NOTE: Base64 templates have been removed to fix a syntax error.
    // You can add them back by uploading the images to your GitHub assets 
    // and putting the jsDelivr URLs here.
    const templates = {
        frames: [],
        photos1: [],
        photos2: [],
